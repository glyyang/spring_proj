 ...
 */
@Entity
@Table(name = "Buyer_Tax_Info")
public class BuyerTaxInfo extends AbstractMwsObject implements Serializable {
	/**
	 * 
	 */
	...
	@OneToMany(mappedBy = "txInfo", fetch = FetchType.LAZY, cascade = {CascadeType.ALL})
    private List<TaxClassification> taxClassifications;

    public BuyerTaxInfo(int id, String companyLegalName, String taxingRegion,
			List<TaxClassification> taxClassifications) {
		super();
		this.id = id;
