...
public class PaymentExecutionDetailItem extends AbstractMwsObject implements Serializable {
	/**
	 * 
	 */
	...
	public PaymentExecutionDetailItem(String payment_id, Orders order_id, Money payment, String paymentMethod) {
		super();
	...
	public String toString() {
		return "PaymentExecutionDetailItem [payment_id=" + payment_id + ", order_id=" + order_id + ", payment="
				+ payment + ", cost=" + cost + ", paymentMethod=" + paymentMethod + "]";
	}
